...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold text-dark"><?= esc($content_title ?? 'Formulir Anggota') ?></h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <!-- Form mengarah ke method 'update' (POST) -->
            <form action="<?= route_to('anggota_update', $anggota['id']); ?>" method="post">
                <?= csrf_field(); ?>
                <!-- Gunakan _method PUT untuk update (RESTful) -->
