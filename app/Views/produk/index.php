...
<div class="container-fluid p-0">
    ...
    <div class="header-controls">
        <h2 class="fw-bold text-dark"><i class="fas fa-filter me-2 text-primary"></i> Daftar Produk Koperasi</h2>
    ...
    <?php
        // Mengambil variabel yang dikirim dari Controller (Produk.php::index)
        $activeJurusan = $jurusan ?? ''; 
        // Menggunakan variabel $data_produk yang dikirim dari Controller
    ...
    <!-- Pilihan Filter Jurusan dan Notifikasi -->
    <div class="mb-4">
        <!-- Area Notifikasi -->
        <?php if ($pesan): ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= route_to('produk_management'); ?>" method="post" class="row g-2 align-items-center">
                <?= csrf_field() ?>
        ...
        <tbody>
            <?php if(!empty($listProduk)): ?>
                ...
                <tr>
                    ...
                    <td><span class="badge bg-info text-dark"><?= esc($row['jurusan']); ?></span></td>
